colabseg.new\_gui\_functions.ColabSegData
=========================================

.. currentmodule:: colabseg.new_gui_functions

.. autoclass:: ColabSegData
   ...
   .. autosummary::
      ...
      ColabSegData.compile_xyz_string
      ColabSegData.convert_tomo
      ColabSegData.crop_fit_around_membrane
      ColabSegData.dbscan_clustering
      ColabSegData.delete_cluster
      ColabSegData.delete_fit
      ...
      ColabSegData.interpolate_membrane_sphere
      ColabSegData.load_hdf
      ColabSegData.load_point_cloud
      ColabSegData.load_protein_position
      ColabSegData.load_stl_file
      ColabSegData.load_tomogram
      ColabSegData.merge_clusters
      ColabSegData.plain_fit_and_rotate_lamina
      ColabSegData.reload_original_values
      ColabSegData.reload_previous_step
      ColabSegData.save_hdf
      ColabSegData.save_values_txt
      ColabSegData.statistical_outlier_removal
      ColabSegData.trim_cluster_egdes_cluster
      ColabSegData.trim_cluster_egdes_fit
      ColabSegData.write_output_mrc
      ColabSegData.write_txt
      ColabSegData.write_xyz
