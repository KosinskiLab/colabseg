...
def generate_tensor_voting_gui():
    ...
    def run_tv_code(obj):
        ...
        subprocess.run(["{}/scale_space".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-s {}".format(all_values["scale_space"].value), "{}.mrc".format(base_name), "{}_sspace.mrc".format(base_name)])
        print("2/7 running dtvoting 1")
        subprocess.run(["{}/dtvoting".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-s {}".format(all_values["tv1_value"].value), "{}_sspace.mrc".format(base_name), "{}_tv1.mrc".format(base_name)])
        print("3/7 running running surfaceness")
        subprocess.run(["{}/surfaceness".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-s {}".format(all_values["m_gaussian_pre"].value), "-p {}".format(all_values["m_gaussian_post"].value), "-m {}".format(all_values["m_thresh"].value), "{}_tv1.mrc".format(base_name), "{}_surf1.mrc".format(base_name)])
        print("4/7 running dtvoting 2")
        subprocess.run(["{}/dtvoting".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-w", "-s {}".format(all_values["tv2_value"].value), "{}_surf1.mrc".format(base_name), "{}_tv2.mrc".format(base_name)])
        print("5/7 running surfaceness saliency")
        subprocess.run(["{}/surfaceness".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-S", "-s {}".format(all_values["s_gaussian_pre"].value), "-p {}".format(all_values["s_gaussian_post"].value), "{}_tv2.mrc".format(base_name), "{}_surf2.mrc".format(base_name)])
        print("6/7 running running threshholding")
        subprocess.run(["{}/thresholding".format(all_values["tensor_voting_path"].value), "-t {}".format(all_values["cpus"].value), "-l {}".format(all_values["thresholding_threshhold"].value), "{}_surf2.mrc".format(base_name), "{}_thresh.mrc".format(base_name)])
        print("7/7 running global_analysis clustering")
        subprocess.run(["{}/global_analysis".format(all_values["tensor_voting_path"].value), "-v 2", "-3 {}".format(all_values["cluster_cutoff"].value), "{}_thresh.mrc".format(base_name), "{}_global2.mrc".format(base_name)])
    ...
    hbox_surface1 = widgets.HBox([all_values["m_gaussian_pre"], all_values["m_gaussian_post"], all_values["m_thresh"]])
    hbox_tv2 = all_values["tv2_value"]
    hbox_surface2 = widgets.HBox([all_values["s_gaussian_pre"], all_values["s_gaussian_post"]])
    ...
    vbox_all = widgets.VBox([hbox_tv_path, hbox_base_name, hbox_cpus, hbox_ssspace, hbox_tv1, hbox_surface1, hbox_tv2, hbox_surface2, hbox_thresh, hbox_cluster_cutoff, hbox_remove_intermediates])
